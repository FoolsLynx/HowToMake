...
namespace HowToMake.SpinningWeapon
{
    public class SpinningWeapon : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.shoot = ModContent.ProjectileType<SpinningWeaponProjectile>();
            item.shootSpeed = 5f;
        }
    ...
    public class SpinningWeaponProjectile : ModProjectile
    {
        public override void SetDefaults()
        {
